            ...
            <Stack sx={{ padding: '21px 4px', background: '' }}>
                ...
                <Grid container columnSpacing={12}>
                    <Grid item xs={12} md={6}>
                        ...
                        <TextField onChange={handleFieldChange} name="name" placeholder="John Doe." fullWidth sx={{ padding: "0", margin: '12px 0', "& .MuiOutlinedInput-root.Mui-focused": { "& > fieldset": { border: '3px solid #40e0d0', color: '#40e0d0' } }, "& .MuiOutlinedInput-root.Mui-focused": { "& > fieldset": { border: '3px solid #40e0d0', color: '#40e0d0' } } }} />

                        <Typography variant="p" width={"100%"} color={"#eee"} sx={{ fontSize: { xs: "18px", md: "21px" } }} fontWeight={"300"}>Requested Artist : </Typography>
                        <Select onChange={handleFieldChange} name="requested_artist" value={booking.requested_artist} fullWidth sx={{ padding: "0", margin: '12px 0', "& .MuiOutlinedInput-root.Mui-focused": { "& > fieldset": { border: '3px solid #40e0d0', color: '#40e0d0' } } }}>
                            ...
                            <MenuItem value="Sound Booking">Sound Booking</MenuItem>
                        </Select>
                    ...
                    <Grid item xs={12} md={6}>
                        ...
                        <TextField onChange={handleFieldChange} name="rider" placeholder="Diesel 500." fullWidth sx={{ padding: "0", margin: '12px 0', "& .MuiOutlinedInput-root.Mui-focused": { "& > fieldset": { border: '3px solid #40e0d0', color: '#40e0d0' } } }} />
