        ...
        <Box sx={{ width: '40%', height: '100%', display: 'flex', justifyContent: 'space-evenly', alignItems: 'center' }}>
            ...
            {item.apple === "" ? ("") : (
                <Link href={item.apple}>
                    <a target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#eee" class="bi bi-apple" viewBox="0 0 16 16">
...

            {
                item.tiktok === "" ? ("") : (
                    <Link href={item.tiktok}>
                        <a target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="radial-gradient(circle at 30% 107%, #fdf497 0%, #fdf497 5%, #fd5949 45%,#d6249f 60%,#285AEB 90%)" class="bi bi-tiktok" viewBox="0 0 16 16">
