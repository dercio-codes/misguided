  ...
  return (
    <Box id="squad-slides" sx={{ margin: "auto 0" }}>
      ...
      >
        <SwiperSlide>
          <img
            src="/misguided-2.jpeg"
            alt="Miguided Entertainment. Karlo , YKM and Dj Shadzo"
          />
        </SwiperSlide>
        <SwiperSlide>
          <img
            src="/misguided-3.jpeg"
            alt="Miguided Entertainment. Karlo , YKM and Dj Shadzo"
          />
        </SwiperSlide>
        <SwiperSlide>
          <img
            src="/misguided-4.jpeg"
            alt="Miguided Entertainment. Karlo , YKM and Dj Shadzo"
          />
        </SwiperSlide>
        <SwiperSlide>
          <img
            src="/misguided-5.jpeg"
            alt="Miguided Entertainment. Karlo , YKM and Dj Shadzo"
          />
        </SwiperSlide>
        <SwiperSlide>
          <img
            src="/misguided-6.jpeg"
            alt="Miguided Entertainment. Karlo , YKM and Dj Shadzo"
          />
        </SwiperSlide>
      </Swiper>
