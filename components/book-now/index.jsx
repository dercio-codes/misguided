        ...
        <Grid container columnSpacing={12}>
          <Grid item xs={12} md={6}>
            ...
            <TextField
              ...
              name="name"
              helperText="Example : Misguided Entertainment"
            ...
            <Select
              ...
              value={booking.requested_artist}
              fullWidth
              sx={{
                padding: "0",
                margin: "12px 0 36px",
            ...
            >
              ...
              <MenuItem value="Dj Shadzo + Dj Karlo">
                Dj Shadzo + Dj Karlo{" "}
              </MenuItem>
              <MenuItem value="Dj Shadzo + YKM Thee MC">
                Dj Shadzo + YKM Thee MC
              </MenuItem>
            ...
            <TextField
              ...
              placeholder="Old School Fridays"
              fullWidth
              sx={{
                padding: "0",
                margin: "12px 0",
          ...
          <Grid item xs={12} md={6}>
            ...
            <TextField
              onChange={handleFieldChange}
              name="event_location"
              helperText="Example : Boksburg , The Classic Indiah Hookah Lounge "
              placeholder="Roodeport Johanessburg."
              fullWidth
              sx={{
                padding: "0",
                margin: "12px 0",
            ...
            <TextField
              ...
              name="duration"
              type="number"
              helperText="How long would you like to book the artist"
              placeholder="2 Hours"
              fullWidth
              sx={{
                padding: "0",
            ...
            <TextField
              ...
              name="budget"
              type="number"
              helperText="What is your budget for the requested artist?"
              placeholder="Budget price exlcudes hospitality"
              fullWidth
              sx={{
                padding: "0",
                margin: "12px 0",
